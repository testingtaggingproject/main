...
## Getting started
Here are the steps to get started with tag diagnostics and empathize with what our users go through.
Use in-product text, Ask Advisor (our AI chat tool), help center, videos, blogs, and other resources to figure these things out and document what you learn as you go.
Ideally, you only use what's available to our users to see what information they might be missing in their tagging journey.
...
### Part 1: Understand tagging

#### Step 1: Launch the website
1. Go to https://codesandbox.io/ 
1. Click "Try for free," then "HTML + CSS," and then "Fork template."
1. Copy the code from here and then paste it into the left side of the site.
1. On your keyboard, press command+S to save the changes. You should see your changes on the right side of the screen in preview.
...
Now that you understand tagging, review each tag diagnostic and look for
...
Check with Rudhra that this list is comprehensive. We've created a bunch of new diagnostics and had a lot more user interaction since this list was created.
